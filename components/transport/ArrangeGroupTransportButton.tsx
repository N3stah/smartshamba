  ...
  return (
    <div className="space-y-2">
      <button 
        ...
        disabled={loading}
        className="w-full bg-public-primary text-white py-2 rounded-lg text-sm font-medium hover:bg-public-primary/90 disabled:opacity-50 flex items-center justify-center gap-2"
      >
