...
export default function InitiateTransactionButton({ listingId }: { listingId: string }) {
  ...
  if (status === 'success') {
    return <div className="flex items-center gap-2 text-public-primary text-sm font-medium bg-green-50 p-2 rounded-lg"><CheckCircle className="w-4 h-4" /> Initiated</div>;
  }
