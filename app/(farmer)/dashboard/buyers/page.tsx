  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {buyers.map((buyer) => (
          <div key={buyer.id} className="bg-surface rounded-lg border border-border shadow-sm p-6 hover:shadow-md transition-shadow flex flex-col">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="bg-farmer-secondary text-farmer-primary text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
            ...
            <div className="border-t border-gray-100 pt-4 mt-auto">
              ...
              <p className="text-2xl font-bold text-farmer-primary">KSh {buyer.pricePerBag.toLocaleString()}</p>
