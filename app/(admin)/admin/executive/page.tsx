    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between border-b border-gray-200 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-text">Executive Command Center</h1>
            <p className="text-sm text-gray-500">Platform performance and operational health</p>
          </div>
        </div>
        <div className="flex gap-2">
          <a href="/api/admin/executive-bi/export" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-500 hover:text-text flex items-center gap-1 bg-white px-3 py-2 rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-public-primary rounded-xl shadow-lg p-6 text-white flex flex-col justify-between">
        ...
        <div className="bg-surface rounded-lg border border-red-200 p-4 space-y-2">
          <h3 className="text-sm font-bold text-text flex items-center gap-2 mb-2"><AlertTriangle className="w-4 h-4 text-red-500" /> Alert Center</h3>
      ...
      {tab === 'CEO' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">{data.ceo.totalFarmers}</p>
          ...
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">{data.ceo.totalBuyers}</p>
            <p className="text-xs text-gray-400 mt-1">+{data.ceo.buyerGrowth} new (30d)</p>
          </div>
          <Link href="/admin/ai-dashboard" className="bg-surface rounded-lg border border-border p-5 hover:border-admin-primary transition-colors cursor-pointer">
            ...
            <p className="text-2xl font-bold text-text">{data.ceo.aiPredictions}</p>
            <p className="text-xs text-gray-400 mt-1">Market models generated</p>
          </Link>
          <Link href="/admin/weather-dashboard" className="bg-surface rounded-lg border border-border p-5 hover:border-admin-primary transition-colors cursor-pointer">
            ...
            <p className="text-2xl font-bold text-text">{data.agintel.weatherAlerts}</p>
      ...
      {tab === 'CFO' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">{data.cfo.successRate}%</p>
          ...
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">{data.cfo.activeTransport}</p>
          ...
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">{data.cfo.activeContracts}</p>
          ...
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">{data.cfo.txVolume30d}</p>
          ...
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">KSh {(data.cfo.revenue30d / 1000).toFixed(1)}K</p>
          ...
          <div className="bg-surface rounded-lg border border-border p-5">
            ...
            <p className="text-2xl font-bold text-text">{data.cfo.pendingWithdrawals}</p>
