          ...
          <form onSubmit={handleCreate} className="bg-surface rounded-lg border border-border shadow-sm p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <input type="tel" placeholder="+254712345678" value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value})} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-admin-primary" />
              </div>
              <div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex gap-8">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-admin-primary">KSh {buyer.pricePerBag.toLocaleString()}</p>
                  </div>
                  <div>
