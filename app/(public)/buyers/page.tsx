      ...
      <main className="flex-1">
        <section className="relative bg-gray-900 overflow-hidden">
          <div className="absolute inset-0">
            <img src={IMAGES["market-produce"]} alt="Market produce" className="w-full h-full object-cover opacity-40" />
          </div>
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Verified Maize Buyers</h1>
        ...
        <section className="py-16 lg:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {buyers.map((buyer) => (
                <div key={buyer.id} className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition-shadow">
            ...
            <div className="mt-20 bg-[#00703C] rounded-2xl p-12 text-center">
              ...
              <Link href="/buyer/login" className="inline-block bg-white text-[#00703C] font-bold px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors">Join SmartShamba</Link>
            </div>
          </div>
        </section>
      </main>
