    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 pb-16 lg:pt-20 lg:pb-24">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="flex flex-col justify-center">
                <p className="text-[#00703C] font-semibold text-xs uppercase tracking-[0.15em] mb-5">THE SMARTSHAMBA OPERATING MODEL</p>
        ...
        <section className="bg-gray-50 py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">The Four Participants</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
                <Users className="w-10 h-10 text-[#00703C] mx-auto mb-4" />
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
                <Target className="w-10 h-10 text-[#00703C] mx-auto mb-4" />
                <h3 className="font-bold text-gray-900 text-lg mb-2">Buyer</h3>
                <p className="text-sm text-gray-600">"Demand" - Publishes demand and coordinates procurement.</p>
              </div>
              <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
                <Truck className="w-10 h-10 text-[#00703C] mx-auto mb-4" />
                <h3 className="font-bold text-gray-900 text-lg mb-2">Transport Provider</h3>
                <p className="text-sm text-gray-600">"Movement" - Picks up and delivers confirmed transactions.</p>
              </div>
              <div className="bg-white border-2 border-[#00703C] rounded-xl p-8 text-center bg-green-50/50">
                <Brain className="w-10 h-10 text-[#00703C] mx-auto mb-4" />
                <h3 className="font-bold text-gray-900 text-lg mb-2">SmartShamba</h3>
        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16">
              <div>
                <p className="text-[#00703C] font-semibold text-xs uppercase tracking-[0.15em] mb-4">1. The Farmer Starts With What They Have</p>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-tight mb-6">USSD Access Without a Smartphone</h2>
                <p className="text-lg text-gray-600 leading-relaxed mb-4">A farmer dials <span className="font-mono font-bold text-[#00703C]">*384*53374#</span> to access SmartShamba. They can register, post available produce, and specify bag sizes (90kg or 50kg).</p>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-8 text-center">The USSD Workflow</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 text-center">
                {["Dial *384#", "Choose Farmer", "Register/Login", "Post Produce", "Select Bag Size (90kg/50kg)", "Enter No. of Bags", "View Buyers", "Confirm"].map((step, i) => (
                  <div key={i} className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-[#00703C] text-white flex items-center justify-center font-bold text-sm mb-2">{i+1}</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16">
              <div className="relative order-2 lg:order-1">
                <div className="relative aspect-4/3 rounded-2xl overflow-hidden shadow-lg">
                  <img src={IMAGES["market-produce"]} alt="Market produce" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="order-1 lg:order-2">
                <p className="text-[#00703C] font-semibold text-xs uppercase tracking-[0.15em] mb-4">2. The Buyer Starts With Demand</p>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-tight mb-6">Coordinating Supply and Demand</h2>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div><p className="font-bold text-gray-900">Farmer</p><p className="text-sm text-gray-500">"I have 80 bags."</p></div>
                    <div className="flex items-center justify-center"><span className="text-[#00703C] font-bold text-2xl">+</span></div>
                    <div><p className="font-bold text-gray-900">Buyer</p><p className="text-sm text-gray-500">"I need 100 bags."</p></div>
                  </div>
                  <div className="mt-6 pt-6 border-t border-gray-100 text-center">
                    <p className="font-bold text-[#00703C]">SmartShamba coordinates the transaction.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <p className="text-[#00703C] font-semibold text-xs uppercase tracking-[0.15em] mb-4">3. SmartShamba Coordinates the Transaction</p>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">From Confirmed Transaction to Delivery</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div className="relative">
                <div className="relative aspect-4/3 rounded-2xl overflow-hidden shadow-lg">
                  <ImageCrossfade
                    images={[
                      { src: IMAGES["white-truck"], alt: "White truck on road" },
                      { src: IMAGES["cargo-crates"], alt: "Cargo crates" },
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Produce Tracking During Transport</h3>
                <div className="space-y-4">
                  {["REQUESTED - Transport requested", "ACCEPTED - Provider accepts job", "LOADED - Produce picked up", "IN TRANSIT - Moving to buyer", "DELIVERED - Arrival confirmed", "COMPLETED - Transaction closed"].map((status) => (
                    <div key={status} className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[#00703C] shrink-0" />
            ...
            <div className="bg-gray-900 text-white rounded-2xl p-8 lg:p-12 grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <CloudRain className="w-10 h-10 text-green-400 mb-4" />
                <h3 className="text-2xl font-bold mb-4">Weather-Aware Transport</h3>
        ...
        <section className="bg-gray-50 py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                <p className="text-[#007033 font-semibold text-xs uppercase tracking-[0.15em] mb-4">5. Group Selling</p>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-tight mb-6">Turning Small Quantities Into One Coordinated Supply</h2>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <p className="font-bold text-gray-900 pt-2 border-t border-gray-100 mt-2">TOTAL: 95 bags (Shared transport, individual settlement)</p>
                  </div>
                </div>
                ...
                <div className="relative aspect-4/3 rounded-2xl overflow-hidden shadow-lg">
                  <ImageCrossfade
                    images={[
                      ...
                      { src: IMAGES["corn-pile-2"], alt: "Another pile of corn" },
                      { src: IMAGES["corn-on-table"], alt: "Corn on table" },
                    ]}
                    interval={3500}
                    className="w-full h-full"
                    imgClassName="object-cover"
        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <p className="text-[#00703C] font-semibold text-xs uppercase tracking-[0.15em] mb-4">SmartShamba Intelligence Layer</p>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Decision Support Built Around Signals</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="border border-gray-200 rounded-xl p-8">
                <TrendingUp className="w-8 h-8 text-[#00703C] mb-4" />
                <h3 className="font-bold text-gray-900 text-lg mb-3">Market Intelligence</h3>
              ...
              <div className="border border-gray-200 rounded-xl p-8">
                <CloudRain className="w-8 h-8 text-[#00703C] mb-4" />
                <h3 className="font-bold text-gray-900 text-lg mb-3">Weather & Agricultural Alerts</h3>
              ...
              <div className="border border-gray-200 rounded-xl p-8">
                <Bell className="w-8 h-8 text-[#00703C] mb-4" />
                <h3 className="font-bold text-gray-900 text-lg mb-3">USSD + Web + SMS</h3>
        ...
        <section className="relative bg-gray-900 text-white py-20 lg:py-28 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6">From Farm to Market, Every Step Connected.</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/market-prices" className="inline-flex items-center justify-center gap-2 bg-[#00703C] text-white px-8 py-3.5 rounded-lg text-sm font-bold hover:bg-[#00582f] transition-colors">
                Explore Market Prices <ArrowRight className="w-4 h-4" />
              </Link>
              <Link href="/buyers" className="inline-flex items-center justify-center gap-2 border border-white/40 text-white px-8 py-3.5 rounded-lg text-sm font-bold hover:bg-white/10 transition-colors">
