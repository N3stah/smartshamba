  ...
  return (
    <>
      ...
      <nav className="bg-white shadow-sm px-6 py-4 flex flex-wrap gap-6 items-center">
        <Link href="/" className="font-bold text-green-800 text-lg">SmartShamba</Link>
        <Link href="/ussd" className="text-gray-700 hover:text-green-700 transition">USSD Demo</Link>
        <Link href="/buyer" className="text-gray-700 hover:text-green-700 transition">Verified Buyers</Link>
        <Link href="/history" className="text-gray-700 hover:text-green-700 transition">Transactions</Link>
        <Link href="/market" className="text-gray-700 hover:text-green-700 transition">Market Prices</Link>
      ...
      <footer className="bg-green-900 text-white mt-16">
        <div className="max-w-6xl mx-auto px-6 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-2xl font-bold">SmartShamba</h3>
            ...
            <div>
              <h4 className="font-semibold text-lg">Pilot Information</h4>
              <ul className="mt-3 space-y-2 text-sm text-green-100">
                <li>USSD: *384*53374#</li>
            ...
            <div>
              <h4 className="font-semibold text-lg">Startup Team</h4>
              <ul className="mt-3 space-y-2 text-sm text-green-100">
